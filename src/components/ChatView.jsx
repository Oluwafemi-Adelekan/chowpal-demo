                                        ...
                                        <div style={{ display: 'flex', gap: 12, marginTop: 12, overflowX: 'auto', paddingBottom: 8, maxWidth: '100%' }}>
                                            {msg.cards.map((card, i) => (
                                                <div key={i} style={{
                                                    ...
                                                    boxShadow: '0 4px 12px rgba(0,0,0,0.08)',
                                                    display: 'flex', flexDirection: 'column',
                                                    border: card.sponsored ? '2px solid #F59E0B' : 'none'
                                                }}>
                                                    {card.sponsored && (
                                                        <div style={{ background: '#FFF7ED', padding: '6px 12px', display: 'flex', alignItems: 'center', gap: 6, borderBottom: '1px solid #FFEDD5' }}>
                                                            <div style={{ width: 6, height: 6, borderRadius: '50%', background: '#F59E0B' }}></div>
                                                            <span style={{ fontSize: 10, fontWeight: 700, color: '#B45309', textTransform: 'uppercase', letterSpacing: '0.5px' }}>Sponsored</span>
                                                        </div>
                                                    )}
